...
public class Command
{
    ...
    {
        // lista wszystkich poleceń jakie możemy wykonać (dobrać kartę, zagrać kartę, zagrać efekt czaru itp.)
        // Są dwie opcje czasowe : 
        // 1) użycie sekwencji animacji i wywołanie CommandExecutionComplete w OnComplete()
        // 2) użycie (IEnumerator) i WaitFor ... aby wprowadzić opóźnienia, wywołanie CommandExecutionComplete () na końcu algorytmu
    }
